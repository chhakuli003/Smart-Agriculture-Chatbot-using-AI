...
Existing Systems
Agricultural Information Portals
Provide farming information through websites.
Require manual searching.
Mobile Farming Applications
Offer weather forecasts and crop information.
Limited conversational capabilities.
AI-Based Chatbots
Support natural language communication.
Improve accessibility and user experience.
Research Gap

Existing systems often lack:

Integrated agricultural guidance.
...
The user enters an agricultural question through the chatbot.

Step 3: Query Processing

The Flask backend processes the query and extracts keywords.

Step 4: Database Search

The system searches the agricultural database for relevant information.

Step 5: Response Generation

The chatbot generates an appropriate response based on the retrieved data.
...
The user interface is developed using HTML, CSS, and JavaScript to provide an interactive and user-friendly chatbot environment.

Backend Development

The Flask framework is used to handle user requests, process queries, and generate appropriate responses.

Database Management

SQLite database is used to store user information and agricultural knowledge such as crop details, fertilizer recommendations, disease management, and government schemes.

Chatbot Functionality

The chatbot receives user queries, identifies keywords, searches the database, and returns relevant responses through the chat interface.

User Authentication

The system provides registration and login functionality to ensure secure access for users.

System Execution

The application runs on a local Flask server, allowing users to interact with the chatbot through a web browser.
...
[4] T. Mikolov, K. Chen, G. Corrado, and J. Dean, “Efficient Estimation of Word Representations in Vector Space,” IEEE, 2013.

[5] S. Russell and P. Norvig, Artificial Intelligence: A Modern Approach, 4th Edition, Pearson, 2021.

[6] D. Jurafsky and J. H. Martin, Speech and Language Processing, Pearson Education.

[7] Food and Agriculture Organization (FAO), “Digital Agriculture and Smart Farming,” Available: https://www.fao.org

[8] Government of India, Ministry of Agriculture and Farmers Welfare, Available: https://agriwelfare.gov.in

[9] NLTK Documentation, “Natural Language Toolkit,” Available: https://www.nltk.org

[10] M. A. Hossain et al., “Agricultural Chatbot for Farmer Support Using Artificial Intelligence,” International Journal of Advanced Computer Science and Applications, vol. 12, no. 5, pp. 245–252, 2021.
